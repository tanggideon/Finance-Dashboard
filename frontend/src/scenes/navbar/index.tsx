...
const Navbar = (props: Props) => {
  ...
  return (
    <Box display="flex" justifyContent="space-between" alignItems="center" mb="0.25rem" p="0.5rem 0rem" color={palette.grey[300]}>
        <Box display="flex" justifyContent="space-between" alignItems="center" gap="0.75rem">
